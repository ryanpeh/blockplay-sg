...
Marina starts with **Waterfront** as its active objective. The companion accepts typed requests or GPT-Live-1 speech, asks GPT-5.6 Luna for a structured destination ID, and applies the proposal through the same local game interface. Try “give me something closer”, “take me to the museum”, or “skip this stop”. The HUD names the objective and the minimap marks it purple. Other regions are unchanged.

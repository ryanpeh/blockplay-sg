...
try {
  ...
  console.log('PASS: Open world route, Marina with one canvas/eight supplies/four bots, three-zone graph, pointer capture, movement, firing, menu, native fullscreen, mobile layout, persistent Armory unchanged and renderer cleanup.');
